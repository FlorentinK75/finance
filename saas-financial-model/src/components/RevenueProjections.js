        ...
        <Paper sx={{ p: 2 }}>
          ...
          <ResponsiveContainer width="100%" height={350}>
            ...
            >
              ...
              <Tooltip content={<CustomTooltip />} />
              <Legend />
              <Bar dataKey="Mutualisation" stackId="a" fill={segmentColors.mutualization} />
              <Bar dataKey="Assistant IA" stackId="a" fill={segmentColors.aiAssistant} />
              <Bar dataKey="Communication" stackId="a" fill={segmentColors.communication} />
              <Bar dataKey="Subventions" stackId="a" fill={segmentColors.subsidies} />
            </BarChart>
          </ResponsiveContainer>
        </Paper>
      </Grid>
